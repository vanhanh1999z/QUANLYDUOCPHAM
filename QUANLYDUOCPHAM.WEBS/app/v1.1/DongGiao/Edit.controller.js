    ...
    sap.ui.define([
        ...
        const oController = {
            ...
            onInit: function() {
                ...
                this.bus.subscribe('DongGiaoChanel', 'loadEditPage', this.loadEditPage, this);
            },
            onExit: function() {
                this.bus.unsubscribe('DongGiaoChanel', 'loadEditPage', this.loadEditPage, this);
            },
            loadEditPage: function(sChanel, sEvent, oData) {
                let root = this;
                new CoreJsonModel().getById(sdConfig.adminApiEndpoint + 'donggiao', String(oData.Id).trim()).success(dt => {
                    if (dt.success === true) {
            ...
            clearForm: function() {
                    ...
                    this.getView().byId('gia').setValue('');
                    this.setState("gia", 'None');
        ...
        getTextInput: function() {
            let bodyData = {
                    ...
                    gia : String(this.getView().byId('gia').getValue()).trim(),
                
            };
            return bodyData
        },
            onCancel: function() {
                this.bus.publish('DongGiaoChanel', 'closeEdit')
                this.clearForm();
            ...
            save: function() {
                ...
                if (true) {
                    ...
                    addModel.postToAPI(sdConfig.adminApiEndpoint + "DongGiao/update", dataBody).success(dt => {
                        MessageToast.show(dt.message);
                        root.onCancel();
                    })
                    this.clearForm();
