        ...
        sap.ui.define([
            ...
            const oController = {
                ...
                onInit: function() {
                    ...
                    this.bus.subscribe('DongGiaoChanel', 'loadDetailPage', this.loadDetailPage, this);
                    this.bus.subscribe('DongGiaoChanel', 'closeEdit', this.closeEdit, this);
                    this.getView().setModel(this.mainModel, 'mainModel');
                },
                onExit: function() {
                    this.bus.unsubscribe('DongGiaoChanel', 'loadDetailPage', this.loadDetailPage, this);
                ...
                onEditButtonPress: function() {
                    ...
                    this.bus.publish('DongGiaoChanel', 'switchToEditPage', {
                        Id: selectedId.id
                    })
                },
            };
