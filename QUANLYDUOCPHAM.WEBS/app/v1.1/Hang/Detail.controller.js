sap.ui.define([
    ...
    const oController = {
        ...
        onInit: function() {
            ...
            this.bus.subscribe('HangChanel', 'loadDetailPage', this.loadDetailPage, this);
            this.bus.subscribe('HangChanel', 'closeEdit', this.closeEdit, this);
            this.getView().setModel(this.mainModel, 'mainModel');
        },
        onExit: function() {
            this.bus.unsubscribe('HangChanel', 'loadDetailPage', this.loadDetailPage, this);
        ...
        onEditButtonPress: function() {
            ...
            this.bus.publish('HangChanel', 'switchToEditPage', {
                Id: selectedId.id
            })
        },
    };
