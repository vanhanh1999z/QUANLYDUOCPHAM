        ...
        sap.ui.define([
            ...
            const oController = {
                ...
                onInit: function() {
                    ...
                    this.bus.subscribe('PhieuThuChanel', 'loadDetailPage', this.loadDetailPage, this);
                    this.bus.subscribe('PhieuThuChanel', 'closeEdit', this.closeEdit, this);
                    this.getView().setModel(this.mainModel, 'mainModel');
                },
                onExit: function() {
                    this.bus.unsubscribe('PhieuThuChanel', 'loadDetailPage', this.loadDetailPage, this);
                ...
                onEditButtonPress: function() {
                    ...
                    this.bus.publish('PhieuThuChanel', 'switchToEditPage', {
                        Id: selectedId.id
                    })
                },
            };
