sap.ui.define([
    ...
    const oController = {
        ...
        onInit: function() {
            ...
            this.bus.subscribe('KhachHangChanel', 'loadDetailPage', this.loadDetailPage, this);
            this.bus.subscribe('KhachHangChanel', 'closeEdit', this.closeEdit, this);
            this.getView().setModel(this.mainModel, 'mainModel');
        },
        onExit: function() {
            this.bus.unsubscribe('KhachHangChanel', 'loadDetailPage', this.loadDetailPage, this);
        ...
        onEditButtonPress: function() {
            ...
            this.bus.publish('KhachHangChanel', 'switchToEditPage', {
                Id: selectedId.id
            })
        },
    };
