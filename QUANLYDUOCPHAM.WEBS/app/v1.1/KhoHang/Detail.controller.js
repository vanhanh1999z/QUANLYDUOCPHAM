        ...
        sap.ui.define([
            ...
            const oController = {
                ...
                onInit: function() {
                    ...
                    this.bus.subscribe('KhoHangChanel', 'loadDetailPage', this.loadDetailPage, this);
                    this.bus.subscribe('KhoHangChanel', 'closeEdit', this.closeEdit, this);
                    this.getView().setModel(this.mainModel, 'mainModel');
                },
                onExit: function() {
                    this.bus.unsubscribe('KhoHangChanel', 'loadDetailPage', this.loadDetailPage, this);
                ...
                onEditButtonPress: function() {
                    ...
                    this.bus.publish('KhoHangChanel', 'switchToEditPage', {
                        Id: selectedId.id
                    })
                },
            };
