sap.ui.define([
    ...
    const oController = {
        ...
        onInit: function() {
            ...
            this.bus.subscribe('DonDatChanel', 'loadDetailPage', this.loadDetailPage, this);
            this.bus.subscribe('DonDatChanel', 'closeEdit', this.closeEdit, this);
            this.getView().setModel(this.mainModel, 'mainModel');
        },
        onExit: function() {
            this.bus.unsubscribe('DonDatChanel', 'loadDetailPage', this.loadDetailPage, this);
        ...
        onEditButtonPress: function() {
            ...
            this.bus.publish('DonDatChanel', 'switchToEditPage', {
                Id: selectedId.id
            })
        },
    };
