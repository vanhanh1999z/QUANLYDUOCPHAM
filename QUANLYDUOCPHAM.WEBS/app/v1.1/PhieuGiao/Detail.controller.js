sap.ui.define([
    ...
    const oController = {
        ...
        onInit: function() {
            ...
            this.bus.subscribe('PhieuGiaoChanel', 'loadDetailPage', this.loadDetailPage, this);
            this.bus.subscribe('PhieuGiaoChanel', 'closeEdit', this.closeEdit, this);
            this.getView().setModel(this.mainModel, 'mainModel');
        },
        onExit: function() {
            this.bus.unsubscribe('PhieuGiaoChanel', 'loadDetailPage', this.loadDetailPage, this);
        ...
        onEditButtonPress: function() {
            ...
            this.bus.publish('PhieuGiaoChanel', 'switchToEditPage', {
                Id: selectedId.id
            })
        },
    };
