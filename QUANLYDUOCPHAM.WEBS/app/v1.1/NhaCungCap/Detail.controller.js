sap.ui.define([
    ...
    const oController = {
        ...
        onInit: function() {
            ...
            this.bus.subscribe('NhaCungCapChanel', 'loadDetailPage', this.loadDetailPage, this);
            this.bus.subscribe('NhaCungCapChanel', 'closeEdit', this.closeEdit, this);
            this.bus.subscribe('KhachHangChanel', 'reloadModelDetail', this.reloadModelDetail, this);

            this.getView().setModel(this.mainModel, 'mainModel');
        },
        onExit: function() {
            this.bus.unsubscribe('NhaCungCapChanel', 'loadDetailPage', this.loadDetailPage, this);
            this.bus.unsubscribe('NhaCungCapChanel', 'closeEdit', this.closeEdit, this);
            this.bus.unsubscribe('KhachHangChanel', 'reloadModelDetail', this.reloadModelDetail, this);
        ...
        reloadModelDetail: function() {
            this.loadDetailPage();
        },
        onEditButtonPress: function() {
            let selectedId = this.getView().getModel('mainModel').getData();
            this.bus.publish('NhaCungCapChanel', 'switchToEditPage', {
                Id: selectedId.id
            })
        },
    };
