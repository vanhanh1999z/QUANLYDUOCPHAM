        ...
        sap.ui.define([
            ...
            const oController = {
                ...
                onInit: function() {
                    ...
                    this.bus.subscribe('DongNhapChanel', 'loadDetailPage', this.loadDetailPage, this);
                    this.bus.subscribe('DongNhapChanel', 'closeEdit', this.closeEdit, this);
                    this.getView().setModel(this.mainModel, 'mainModel');
                },
                onExit: function() {
                    this.bus.unsubscribe('DongNhapChanel', 'loadDetailPage', this.loadDetailPage, this);
                ...
                onEditButtonPress: function() {
                    ...
                    this.bus.publish('DongNhapChanel', 'switchToEditPage', {
                        Id: selectedId.id
                    })
                },
            };
